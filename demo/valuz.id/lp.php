<?php
    ...
    function tampilgambar($idProduk, $kriteria){
        $koneksi = new mysqli('localhost', "u5216341_user", "@passwordDB#", "u5216341_valuz");
        $sqlGbr = "SELECT * FROM gambar where produk='$idProduk' AND kriteria='$kriteria'";
        $result = $koneksi->query($sqlGbr);
        if ($result->num_rows > 0){

        while($gbr = $result->fetch_assoc()){
            ?>  
                <div class="image-produk">
                    <img src="https://valuz.id/admin/assets/uploads/files/<?= $gbr['file_gambar'] ?>" alt="" width=100%>
                </div>
            <?php
            }
        }
                            ...
                            <div class="col-lg-12">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <table class="table table-striped" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>Kode </td>
                                                                <td class="text-left">VLZ<?= $kode ?>    
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Harga</td>
                                                                <td class="text-left">Rp. <?= number_format($harga_produk,0,',','.'); ?> <s><?= number_format($harga_coret,0,',','.'); ?></s></td>
                                                            </tr>
                                                        </tbody>
                                                </table>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <table class="table table-striped" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td>Stok</td>
                                                                <td class="text-left">Ready</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Berat(/pcs)</td>
                                                                <td class="text-left"><?= $row['berat'] ?>Kg</s></td>
                                                            </tr>
                                                        </tbody>
                                                </table>
                                            </div>
                                ...
                                <div class="detail-produk">
                                    ...
                                    <div class="isi-detail-produk">
                                        ...
                                        <div class="masalah">
                                            <?= $masalah ?>
                                            <?= tampilgambar($id, "masalah") ?>
                                        </div>
                                        <hr>
                                        <div class="solusi">
                                            <?= $solusi ?>
                                            <?= tampilgambar($id, "solusi") ?>
                                        </div>
                                        <hr>
                                        <div class="manfaat">
                                            <?= $manfaat ?>
                                    ...
                                    <form action="input.php" method="GET">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="whatsapp" id="" aria-describedby="helpId" placeholder="Whatsapp (08xxxxxx)" required>
