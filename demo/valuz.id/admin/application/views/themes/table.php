    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="<?php echo site_url(); ?>">&nbsp;&nbsp;VALUZ.ID</a>
          <div style="height: 0px;" class="nav-collapse">
            <ul class="nav">
			  <li class="active"><a href="<?php echo site_url(); ?>">Home</a></li>
			  <!--  produk berisi omzet (tahunan, bulanan, harian) -->
			  <li><a href="<?php echo site_url('data/index/produk'); ?>">Produk</a></li>
			  <!-- VLZ0001 :  kode produk-->
			  <li><a href="<?php echo site_url('data/index/tbl_wa'); ?>">Costumer</a></li>
			  <li><a href="<?php echo site_url('data/index/tbl_wa'); ?>">Payment</a></li>
			  <li><a href="<?php echo site_url('data/index/tbl_wa'); ?>">Expense</a></li>
			  <li><a href="<?php echo site_url('data/index/tbl_wa'); ?>">Report</a></li>
			  <li><a href="<?php echo site_url('data/index/tbl_wa'); ?>">Analyzer</a></li>
			  <li><a href="<?php echo site_url('data/index/tbl_wa'); ?>">Setting</a></li>
			  <!-- <li><a href="<?php echo site_url('data/index/produk'); ?>">Produk</a></li>
              <li><a href="<?php echo site_url('data/index/kategori'); ?>">Kategori</a></li>
              <li><a href="<?php echo site_url('data/index/slide'); ?>">Slide</a></li>
              <li><a href="<?php echo site_url('data/index/testimoni'); ?>">Testimoni</a></li>
              <li><a href="<?php echo site_url('data/index/gambar'); ?>">Gambar</a></li> -->
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
